...
const Testimonials = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content: 'The ball handling drills are incredible. I went from struggling with basic dribbles to executing complex moves confidently.',
      rating: 5
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Hear from athletes who have transformed their game with B.E.A.R.D. Training
          </p>
        </motion.div>
