...
const DrillsLibrary = () => {
  ...
  const categories = [
    ...
    { id: 'fundamentals', name: 'Fundamentals', icon: FiTarget }
  ];
  ...
  const loadDrills = () => {
    ...
    if (savedDrills) {
      ...
      // Use default drills if none saved
      const defaultDrills = [
        {
          id: 1,
        ...
        },
        {
          ...
          featured: false,
          thumbnail: 'https://images.unsplash.com/photo-1577212017184-7d6ca4cf8b2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80',
          video: '',
          mediaType: 'image'
        },
        {
          ...
          featured: false,
          thumbnail: 'https://images.unsplash.com/photo-1559692048-79a3f837883d?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&q=80',
          video: '',
          mediaType: 'image'
        },
        {
      ...
      localStorage.setItem('basketballDrills', JSON.stringify(defaultDrills));
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Master your skills with our comprehensive collection of basketball drills, complete with video tutorials and step-by-step instructions.
          </p>
        </motion.div>
        ...
        {featuredDrills.length > 0 && (
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {featuredDrills.slice(0, 3).map((drill) => (
